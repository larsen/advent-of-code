...
(defun aoc2021/day6/solution1 ()
  (evolve-population (read-csv-line (asdf:system-relative-pathname
                                     'advent-of-code "inputs/2021/day6")) 80))

(defun aoc2021/day6/solution2 ()
  (let ((population-age (make-array 9)))
    (loop for p in (read-csv-line (asdf:system-relative-pathname
                                   'advent-of-code "inputs/2021/day6"))
