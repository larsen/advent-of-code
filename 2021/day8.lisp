...
(defun read-seven-segments-notes ()
  (loop for l in (uiop:read-file-lines (asdf:system-relative-pathname
                                        'advent-of-code "inputs/2021/day8"))
        collect (mapcar (lambda (str)
                          (split " " str))
                        (split " \\| " l))))

(defun aoc2021/day8/solution1 ()
